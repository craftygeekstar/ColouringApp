...
public class BrushStrokeMesh : MonoBehaviour
{
    ...
    private void Awake() 
    {
        ...
        // In addition to clearing the ribbon, this adds a ribbon point that we'll move each frame to match the brush tip position so that the brush stroke appears to paint continuously.
        ClearRibbon();
